    ...
    <div className="container">
      ...
      {virsion == true && (
        <div className="add-virsion">
          <div className="item">
            <form>
              <div className="input">
                <label htmlFor="android">Bot Version</label>
                <input type="text" id="android" />
              </div>

              <div className="input">
                <label htmlFor="ios">Bot Mode</label>
                <input type="text" id="ios" />
              </div>

              <div className="input">
                <label htmlFor="force">Bot Difficulty</label>
      ...
      <div id="kyc-management">
        ...
        <div className="pending-content">
          <div className="search-filter search-item">
            <button onClick={() => setVirsion(true)} type="button">
              Add
            </button>
          </div>
